...
1 <= k <= 100
All strings in words consist of lowercase English letters.©leetcode
 */
...
public class PrefixConnectedGroups {
    public static void main(String[] args) {
        ...
        int k = 3;
        int ans = prefixConnected(words, k);
        System.out.println(ans);
    }

    private static int prefixConnected(String[] words, int k) {
